...
public class Common {
	...
	public void onInitialize() {
		...
		if (!FabricLoader.getInstance().isModLoaded("fabric") && !FabricLoader.getInstance().isModLoaded("fabric-api")) {
			throw new RuntimeException("any of the two old and new Fabric API were not found :(");
		}
		...
		Registry.register(Registry.ITEM, BROWN_BEAR_ID, new CuddlyItem(new Item.Settings().maxCount(1).group(ItemGroup.MISC), "item.blahaj.brown_bear.tooltip"));
